...
namespace OpenBullet
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            var title = $"▄︻デ𝕺𝖕𝖊𝖓𝖇𝖚𝖑𝖑𝖊𝖙 𝕲3𝖛3𝖗══━一 {OB.Version}";
            Title = title;
            ...
            this.menuOptionRunner_MouseDown(this, null);
            int startingWidth = OB.OBSettings.General.StartingWidth;
            int startingHeight = OB.OBSettings.General.StartingHeight;
            if (startingWidth > 800)
            {
                base.Width = (double)startingWidth;
            }
            if (startingHeight > 600)
            {
                base.Height = (double)startingHeight;
            }
        ...
        {
            System.Windows.Forms.Form formulario = new Form1();
            formulario.Show();
        }
