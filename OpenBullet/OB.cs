...
namespace OpenBullet
{
    public static class OB
    {
        public static IApplication App => new OpenBulletApp()
        {
            ...
            ProxyManager = (IProxyManager)ProxyManager,
            ProxyChecker = (IProxyChecker)ProxyManager,
        ...
        public static object Blank { get; internal set; }
        // Constant file paths
        ...
        public static readonly string defaultProxySiteUrl = "http://ip-api.com/json/";
